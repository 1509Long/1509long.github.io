...
var informationTokenHomePage = [
    btc = {
      box1: '<i class="fas fa-star watch-list" onclick="informationTokenHomePage[1].btc.myMethod"></i>',
      asset:
      ...
      myMethod: function clinkMe () {
        let abc = document.querySelector("watch-list");
        abc.classList.toggle("yellow");
