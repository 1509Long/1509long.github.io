...
var informationTokenHomePage = [
    btc = {
      ...
      myMethod: function() {
        ...
        let first = document.querySelector(".watchlist-table tr:first-child");
    ...
    eth = {
      ...
      myMethod: function() {
        ...
        let second = document.querySelector(".watchlist-table tr:nth-child(2)");

        if (eth.classList.contains("yellow")) {
          eth.classList.remove("yellow");
          second.classList.add("disappear");
        } else {
          eth.classList.add("yellow");
    ...
    ltc = {
      ...
      myMethod: function() {
        ...
        let third = document.querySelector(".watchlist-table tr:nth-child(3)");

        if (ltc.classList.contains("yellow")) {
          ltc.classList.remove("yellow");
          third.classList.add("disappear");
        } else {
          ltc.classList.add("yellow");
    ...
    iotx = {
      ...
      myMethod: function() {
        ...
        let fourth = document.querySelector(".watchlist-table tr:nth-child(4)");

        if (iotx.classList.contains("yellow")) {
          iotx.classList.remove("yellow");
          fourth.classList.add("disappear");
        } else {
          iotx.classList.add("yellow");
          fourth.classList.remove("disappear");
        }
      },
    },
    trx = {
      ...
      myMethod: function() {
        ...
        let fifth = document.querySelector(".watchlist-table tr:nth-child(5)");

        if (trx.classList.contains("yellow")) {
          trx.classList.remove("yellow");
          fifth.classList.add("disappear");
        } else {
          trx.classList.add("yellow");
          fifth.classList.remove("disappear");
        }
      },
    },
    eos = {
      ...
      myMethod: function() {
        ...
        let sixth = document.querySelector(".watchlist-table tr:nth-child(6)");

        if (eos.classList.contains("yellow")) {
          eos.classList.remove("yellow");
          sixth.classList.add("disappear");
        } else {
          eos.classList.add("yellow");
          sixth.classList.remove("disappear");
        }
      },
    },
    theta = {
      ...
      myMethod: function() {
        ...
        let seventh = document.querySelector(".watchlist-table tr:nth-child(7)");

        if (theta.classList.contains("yellow")) {
          theta.classList.remove("yellow");
          seventh.classList.add("disappear");
        } else {
          theta.classList.add("yellow");
          seventh.classList.remove("disappear");
        }
      },
    },
    ogn = {
      ...
      link: '<a href="#" class="click-here">Giao dịch ngay</a>',
      myMethod: function() {
        let ogn = document.querySelector(".ogn");
        let eighth = document.querySelector(".watchlist-table tr:nth-child(8)");

        if (ogn.classList.contains("yellow")) {
          ogn.classList.remove("yellow");
          eighth.classList.add("disappear");
        } else {
          ogn.classList.add("yellow");
          eighth.classList.remove("disappear");
        }
      },
    },
    tfuel = {
      ...
      link: '<a href="#" class="click-here">Giao dịch ngay</a>',
      myMethod: function() {
        let tfuel = document.querySelector(".tfuel");
        let ninth = document.querySelector(".watchlist-table tr:nth-child(9)");

        if (tfuel.classList.contains("yellow")) {
          tfuel.classList.remove("yellow");
          ninth.classList.add("disappear");
        } else {
          tfuel.classList.add("yellow");
          ninth.classList.remove("disappear");
        }
      },
    },
    rep = {
      ...
      myMethod: function() {
        ...
        let tenth = document.querySelector(".watchlist-table tr:nth-child(10)");

        if (rep.classList.contains("yellow")) {
          rep.classList.remove("yellow");
          tenth.classList.add("disappear");
        } else {
          rep.classList.add("yellow");
          tenth.classList.remove("disappear");
        }
      },
    },
    tust = {
      ...
      link: '<a href="#" class="click-here">Giao dịch ngay</a>',
      myMethod: function() {
        let tust = document.querySelector(".tust");
        let eleventh = document.querySelector(".watchlist-table tr:nth-child(11)");

        if (tust.classList.contains("yellow")) {
          tust.classList.remove("yellow");
          eleventh.classList.add("disappear");
        } else {
          tust.classList.add("yellow");
          eleventh.classList.remove("disappear");
        }
      },
    },
    qtum = {
      ...
      link: '<a href="#" class="click-here">Giao dịch ngay</a>',
      myMethod: function() {
        let qtum = document.querySelector(".qtum");
        let twelfth = document.querySelector(".watchlist-table tr:nth-child(12)");

        if (qtum.classList.contains("yellow")) {
          qtum.classList.remove("yellow");
          twelfth.classList.add("disappear");
        } else {
          qtum.classList.add("yellow");
          twelfth.classList.remove("disappear");
        }
      },
    },
    neo = {
      ...
      myMethod: function() {
        ...
        let thirteenth = document.querySelector(".watchlist-table tr:nth-child(13)");

        if (neo.classList.contains("yellow")) {
          neo.classList.remove("yellow");
          thirteenth.classList.add("disappear");
        } else {
          neo.classList.add("yellow");
          thirteenth.classList.remove("disappear");
        }
      },
    },
    ftt = {
      ...
      myMethod: function() {
        ...
        let fourteenth = document.querySelector(".watchlist-table tr:nth-child(14)");

        if (ftt.classList.contains("yellow")) {
          ftt.classList.remove("yellow");
          fourteenth.classList.add("disappear");
        } else {
          ftt.classList.add("yellow");
          fourteenth.classList.remove("disappear");
        }
      },
    },
    gto = {
      box1: '<i class="fas fa-star watch-list" onclick=gto.myMethod()></i>',
      asset:
      ...
      link: '<a href="#" class="click-here">Giao dịch ngay</a>',
      myMethod: function() {
        let gto = document.querySelector(".gto");
        let fifteenth = document.querySelector(".watchlist-table tr:nth-child(14)");

        if (gto.classList.contains("yellow")) {
          gto.classList.remove("yellow");
          fifteenth.classList.add("disappear");
        } else {
          gto.classList.add("yellow");
          fifteenth.classList.remove("disappear");
        }
      },
    },
    {
